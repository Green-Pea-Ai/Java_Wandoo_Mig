...
// 아래 두줄 정체 불명의 import임(tab 눌러서 변수 만들때 들어왔나봄)
...
class Bachelor extends Person {
    // 미국은 2전공이 기본?
    // 컴공, 통계, 물리, (전기전자) 3~4전공까지도 있다.
    // 아마존 회장은 전기전자, 컴공 수석졸업 (물리학과 학생)
    // 친구들이 문제 더 빨리 풀어서 이쪽으로 왔다고 함
...
// 1. Person을 Bachelor(학사)와 Master가 상속받도록 한다.
...
/* 숙제 (당장할 필요없으니 고민해보기)
*  현재와 같은 학사, 석사 학생들을 랜덤으로 다수 만든 다음에(이름도 랜덤)
